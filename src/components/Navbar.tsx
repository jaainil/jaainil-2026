      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-stretch h-16">
          <div className="flex items-stretch">
            <Link to="/" className="flex items-center pr-6 md:pr-8 border-r border-zinc-200 hover:bg-zinc-50 transition-colors">
          ...
          <div className="flex items-stretch text-zinc-400">
            <a href="#" className="flex items-center px-4 border-l border-zinc-200 hover:bg-zinc-50 hover:text-zinc-900 transition-colors">
